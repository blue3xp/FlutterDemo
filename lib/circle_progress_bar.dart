...
class CircleProgressBarPainter extends CustomPainter {
  ...
  CircleProgressBarPainter({
    ...
    double strokeWidth,
  }) : this.strokeWidth = strokeWidth ?? 26;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final offset1 = Offset(center.dx - 50+15, center.dy - 50);
    final offset2 = Offset(center.dx - 50, center.dy - 15);
    final offset3 = Offset(center.dx - 50+30, center.dy + 20);
    _drawText(canvas, 30, 'Steps', offset1, size.width);
    double percentageVal = 12000 + this.percentage * 100;
    _drawText(canvas, 35, percentageVal.toStringAsFixed(0), offset2, size.width);
    _drawText(canvas, 15, 'Today', offset3, size.width);
  }

  void _drawText(Canvas canvas, double fontSize, String val, Offset offset,double maxWidth) {
